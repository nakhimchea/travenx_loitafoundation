...
import 'package:travenx_loitafoundation/widgets/landscape/home_screen/login_card_button.dart';
import 'package:travenx_loitafoundation/widgets/landscape/home_screen/login_text_field.dart';
          ...
          children: [
            ...
            Text('លក្ខខណ្ឌ និងគោលនយោបាយឯកជនភាព',
                ...
                style: Theme.of(context)
                    .textTheme
                    .button!
                    .copyWith(fontSize: 8.0, fontWeight: FontWeight.w700)),
          ],
        ),
      ),
    );
